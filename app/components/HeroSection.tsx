          ...
          <div className="space-y-4 sm:space-y-6 mt-6 sm:mt-8">
            <div className="flex flex-col items-center gap-4">
              ...
              <p className="text-base sm:text-lg text-gray-400 max-w-2xl px-4 sm:px-0">
                Building robust, scalable, and user-centric web and mobile
                solutions. Passionate about modern tech, teamwork, and
            ...
            {[
              {
                name: "GitHub",
                icon: "🐙",
                href: "https://github.com/FruBoris",
              },
              {
                name: "LinkedIn",
                icon: "💼",
              ...
              },
              {
                name: "Twitter",
                icon: "🐦",
                href: "https://x.com/FRUBORIS3?t=dNs60w6lcnB8chegDNZT5A&s=09",
              },
