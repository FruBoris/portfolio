...
export const metadata: Metadata = {
  ...
  authors: [{ name: "Fru Boris" }],
  creator: "Fru Boris",
  openGraph: {
    title: "Fru Boris - Web Developer Portfolio",
    description:
    ...
    siteName: "Fru Boris - Portfolio",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
        height: 630,
        alt: "Fru Boris - Web Developer Portfolio",
      },
    ],
    locale: "en_US",
    type: "website",
